      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="flex flex-1 p-4">
          <div className="pr-2 pl-10 flex flex-col">
            <div className="bg-white rounded-3xl shadow-lg p-4 flex- lg:w-[20vw] lg:h-full lg:-ml-[2rem]">
              <h2 className="text-lg font-semibold text-center pt-10 mb-4 lg:mb-2 lg:pt-2">List of Products</h2>
              <ProductList />
            </div>
          </div>
