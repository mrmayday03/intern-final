      ...
      <div className="flex h-screen">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <div className="h-screen flex flex-row">
            <div className="top-[20vh] left-[65vh] bg-white w-[50rem] h-[75vh] m-10 rounded-2xl p-4">
              <p className="ml-[2rem] text-2xl text-gray-500 font-bold mb-4">Categories</p>
              <div className="grid grid-cols-2 gap-4 mb-10">
                {categories.map((category, index) => (
                  <div
                    className={`card-type ${category.color} w-[18rem] h-[10rem] ml-8 rounded-2xl`}
                    key={index}
                  ...
                  >
                    <div className="content flex items-center justify-between p-4 ml-8">
                      <div className="left-side flex items-center">
                        <div className={`${category.color} bg-transparent rounded-full w-12 h-12 flex flex-col m-10 items-center justify-center`}>
